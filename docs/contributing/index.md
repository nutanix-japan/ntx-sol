...
This is an actively maintained and constantly evolving project
...
our [documentation] – yielding value to both new and experienced users.
  ...
  [discussion board]: https://github.com/nutanix-japan/ntx-sol/discussions
  [issue tracker]: https://github.com/nutanix-japan/ntx-sol/issues
...
- Does your comment add value to the conversation? Is it constructive and
  ...
  [Code of Conduct]: https://github.com/nutanix-japan/ntx-sol/blob/master/CODE_OF_CONDUCT.md
